...
module.exports = {
  BASES: expand(BASES, TIER_WEIGHT),
  BACKGROUNDS: expand(BACKGROUNDS, { common: 70, uncommon: 22, rare: 7, legendary: 1 }),
  GRADES: expand(GRADES, { common: 70, uncommon: 22, rare: 7, legendary: 1 }),
  FRAMES: expand(FRAMES, { common: 70, uncommon: 22, rare: 7, legendary: 1 }),
  pick,
};
